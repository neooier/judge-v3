export const lang =  {
    ...
    compile: (sourcePath, outputDirectory, doNotUseX32Abi) => ({
        ...
        parameters: ["g++-8", sourcePath, "-o", `${outputDirectory}/a.out`, "-std=c++14", "-fsanitize=undefined,float-cast-overflow,float-divide-by-zero", "-fno-sanitize-recover", "-fdiagnostics-color=always", "-DONLINE_JUDGE", !doNotUseX32Abi && "-mx32"].filter(x => x),
        time: 5000,
